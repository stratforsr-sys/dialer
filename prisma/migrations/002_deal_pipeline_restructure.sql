-- ============================================================
-- Migration: deal-pipeline-restructure
-- Leads leave the pipeline. Deals own pipeline stages.
-- Apply this to your Turso DB via the Turso dashboard SQL editor
-- or: turso db shell <db-name> < prisma/migrations/002_deal_pipeline_restructure.sql
-- ============================================================

PRAGMA foreign_keys=OFF;

-- ── 1. Lead: add hasActiveDeal, drop stageId ────────────────
...
-- ── 2. Deal: expand with stage, value type, probability ─────
CREATE TABLE "Deal_new" (
    ...
    "stageId" TEXT NOT NULL DEFAULT (
        SELECT "id" FROM "PipelineStage" ORDER BY "order" ASC LIMIT 1
    ),
...
-- ── 5. Mark existing leads that have deals as hasActiveDeal ─
