...
import { Users, Layers, Plus, Trash2, Shield, User, X } from "lucide-react";
...
export function AdminView({ users, stages }: { users: UserRow[]; stages: Stage[] }) {
